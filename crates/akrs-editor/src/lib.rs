...
impl BlueprintState {
    ...
    fn kind_label(kind: NodeKind) -> &'static str {
        match kind {
            NodeKind::Section => "章节",
            NodeKind::Dialogue => "对话",
            NodeKind::Narration => "旁白",
            NodeKind::Command => "命令",
            NodeKind::Direction => "立绘",
            NodeKind::Choice => "选择",
            NodeKind::Flow => "跳转",
            NodeKind::Visit => "访问",
            NodeKind::Return => "返回",
            NodeKind::Wait => "等待",
            NodeKind::StoryEnd => "结局",
            NodeKind::Ending => "结局声明",
            NodeKind::Unlock => "解锁",
            NodeKind::VarOp => "变量",
            NodeKind::Other => "其他",
        }
    ...
    fn show_blueprint(&mut self, ui: &mut egui::Ui) {
        ...
        for node in &bp.nodes {
            ...
            clipped.text(
                ...
                BlueprintState::kind_label(node.kind),
        ...
        // ---- 底部文本编辑栏 ----
        ui.separator();
        let selected_id = self.blueprint.selected;
