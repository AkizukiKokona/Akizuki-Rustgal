...
fn builtin_english(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        // 配色标签页
        "settings.color.title" => "Color Customization",
        "settings.color.hint" => "Click a swatch or palette preset, or type #RRGGBB in the hex box. Theme colors can use the project default.",
        "settings.color.theme_primary" => "Theme 1 (Panel)",
        "settings.color.theme_secondary" => "Theme 2 (Button)",
        "settings.color.theme_dialogue" => "Dialogue Box",
        "settings.color.read_text" => "Read Text",
        "settings.color.unread_text" => "Unread Text",
        "settings.color.use_custom" => "Custom",
        "settings.color.use_default" => "Project Default",
        "settings.color.reset" => "Reset",
        // 开发者模式标签页
        "settings.dev.title" => "Developer Mode",
        "settings.dev.warning" => "Do NOT change anything on this page unless you know what you are doing.",
        "settings.dev.debug_terminal" => "Show Debug Terminal",
        "settings.dev.clear_read_history" => "Mark All Text as Unread",
        "settings.dev.clear_read_history_hint" => "Clears the read history so every line is treated as unread again.",
        // 快进模式
...
"#;
    ...
    fn test_builtin_english_covers_all_known_keys() {
        ...
        for key in [
            ...
            "settings.tab.display", "settings.tab.skip", "settings.tab.color",
            ...
            "settings.color.title", "settings.color.hint",
            "settings.color.theme_primary", "settings.color.theme_secondary",
            "settings.color.theme_dialogue", "settings.color.read_text",
            "settings.color.unread_text", "settings.color.use_custom",
            "settings.color.use_default", "settings.color.reset",
            "settings.dev.title", "settings.dev.warning",
            "settings.dev.debug_terminal",
            "settings.dev.clear_read_history", "settings.dev.clear_read_history_hint",
